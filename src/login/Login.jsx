        ...
        <div className="login-bar">
            <div className="col-md-6" style={{ paddingLeft: "4%" }}> <form><div class="form-group" style={{ width: "80%", marginTop: "40%" }} >
                ...
                <div className="form-group" style={{ width: "80%" }}>
                    ...
                    <input type="submit" className="mybtn btn btn-warning" id="signin" value="Sign In" />
                </div></form></div>
            <div className="col-md-6 social-login" > 
            <div className="sl-top">
                
            </div>
            <div className="sl-bottom"><input type="submit" className=" mybtn sl btn btn-danger" id="google" value="Sign In With Google" />
            <input type="submit" className="sl mybtn btn btn-primary" id="facebook" value="Sign In With Facebook" />
            </div>
            </div>
        </div>
    </div>;
